...
export default function PublicHeader(){
    ...
    return(
        <header className={`transition-[max-height] max-w-screen max-h-[70px] pb-1 sm:pb-1 bg-light-main dark:bg-dark-main  shadow-md tracking-tight z-20 flex gap-2 tiny:gap-0 items-center justify-center px-2 md:px-5 lg:px-10 py-1`}>
            <div className={""}>
                <Link href={baseURL}>
