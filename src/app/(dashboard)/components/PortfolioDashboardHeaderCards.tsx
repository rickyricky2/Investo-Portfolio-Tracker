...
export default function PortfolioDashboardHeaderCards({totalBalance, values, isLoading, currency}: {totalBalance: number; values: {label:string, value:number, percent?:number;}[]; isLoading:boolean; currency:string } ) {
    return(
        <div>
            <section className={"min-h-[150px] bg-[linear-gradient(130deg,var(--color-light-main),hsl(300,70%,80%))] dark:bg-[linear-gradient(130deg,var(--color-dark-main),hsl(266,50%,28%))] w-full shadow-lg rounded-4xl overflow-hidden font-medium"}>
